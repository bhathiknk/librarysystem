...
namespace library_system_C__group_project
{
    ...
    {
        private AddBook viewbookParentForm;
        public viewbook(AddBook viewbookParentForm)
        {
            InitializeComponent();
            this.viewbookParentForm = viewbookParentForm;
        }
        ...
        private void ViewBookPreviousToAddBooks_Click(object sender, EventArgs e)
        {
            viewbookParentForm.Show(); // Show the existing StudentDashBoard form
