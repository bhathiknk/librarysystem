...
namespace library_system_C__group_project
{
    ...
    {
        private dashbord returnbookParentForm;
        string randomCode;
        public static string to;


        public ReturnBook(dashbord returnbookParentForm)
        {
            InitializeComponent();
            this.returnbookParentForm = returnbookParentForm;
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                smtp.Send(message);
                MessageBox.Show("Code send Successfully.", "Success", MessageBoxButtons.OK, MessageBoxIcon.Information);
        ...
        {
            returnbookParentForm.Show(); // Show the existing StudentDashBoard form
