...
namespace library_system_C__group_project
{
    ...
    {
        private dashbord issuebookParentForm;

        public IssueBooks(dashbord issuebookParentForm)
        {
            InitializeComponent();
            this.issuebookParentForm = issuebookParentForm;
        }
        ...
        {
            issuebookParentForm.Show(); // Show the existing StudentDashBoard form
