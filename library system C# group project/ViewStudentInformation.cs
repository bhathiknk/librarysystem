...
namespace library_system_C__group_project
{
    ...
    {
        private AddStudent viewstudentParentForm;
        public ViewStudentInformation(AddStudent viewstudentParentForm)
        {
            InitializeComponent();
            this.viewstudentParentForm = viewstudentParentForm;
        }
        ...
        private void ViewStudentToExitDashBoard_Click(object sender, EventArgs e)
        {
        ...
        private void ViewStudentsToPrevious_Click(object sender, EventArgs e)
        {
            viewstudentParentForm.Show(); // Show the existing StudentDashBoard form
